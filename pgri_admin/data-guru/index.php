		...
		<div class="row pt-3 justify-content-end">
			...
			<div class="konten pt-5 pl-5 pr-5" id="konten">
				...
				<table class="display table table-bordered" id="dataTables" width="100%">
					...
					<tbody>
						...
						foreach ($dataGuru as $row) {
							...
							echo "<td><a class='btn btn-outline-info' type='button' href='edit.php?kode_guru=" . $row['kode_guru'] . "'>Edit</a></td>";
							echo "</tr>";
				...
				<div>
					...
					<a class="btn btn-outline-primary font-weight-bold" type="button" href="input.php">Input Guru</a>
