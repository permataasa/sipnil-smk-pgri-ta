                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-lg-3">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="kode_guru" id="kode_guru">
                    ...
                    <div class="row justify-content-center mb-5">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                ...
                                <input class="btn btn-outline-primary font-weight-bold" type="submit" name="input-guru" value="Simpan">
