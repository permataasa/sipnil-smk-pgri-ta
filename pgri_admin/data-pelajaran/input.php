                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="kode_pelajaran" id="kode_pelajaran">
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="kkm" id="kkm">
                    ...
                    <div class="row justify-content-center mb-5">
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="form-group">
                                ...
                                <input class="btn btn-outline-primary font-weight-bold" type="submit" name="input-pelajaran" value="Simpan">
