                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-lg-3">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="kode_jurusan" id="kode_jurusan" value="<?php echo $dataJurusan['kode_jurusan']?>">
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-lg-3">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="jurusan" id="jurusan" value="<?php echo $dataJurusan['jurusan']?>">
                    ...
                    <div class="row justify-content-center mb-5">
                        ...
                        <div class="col-lg-3">
                            ...
                            <div class="form-group">
                                ...
                                <input class="btn btn-outline-primary font-weight-bold" type="submit" name="edit-jurusan" value="Simpan">
