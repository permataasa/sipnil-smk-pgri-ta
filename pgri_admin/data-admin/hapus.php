			...
			<div class="konten pt-5 pl-5 pr-5" id="konten">
                ...
                <form class="form" action="" method="POST">
                    ...
                    <table class="display table table-bordered" id="dataTables" width="100%">
                        ...
                        <tbody>
                            ...
                            foreach ($dataAdmin as $row) {
                                ...
                                echo "<input class='form-check-input' type='checkbox' name='id_admin[]' value='" . $row['id_admin'] . "'>";
                                echo "</div>";
                                echo "</td>";
                                echo "</tr>";
                    ...
                    <div>
                        ...
                        <input class="btn btn-outline-danger font-weight-bold" type="submit" name="hapus-admin" value="Hapus">
